...
class AITCApplication:
    ...
    def __init__(self, *, config_sync_manager, http_server, tcp_server, decision_pipeline, flow_predictor, queue_predictor, prediction_hour, prediction_minute, send_interval, logger=None):
    ...
    def start(self) -> None:
        ...
        self.flow_predictor.setup_scheduler(self.prediction_hour, self.prediction_minute)
        self.queue_predictor.setup_scheduler(self.prediction_hour, self.prediction_minute)
